...
import { ClinicalAccountsFormValues } from "../clinicalAccounts/clinicalAccountsHelper";

type ClinicalPreviewDataDialogProps = {
    showPreview: boolean;
    onHidePreview: () => void;
    values: ClinicalAccountsFormValues
}

const ClinicalPreviewDataDialog = (props: ClinicalPreviewDataDialogProps) => {
...
export default ClinicalPreviewDataDialog;